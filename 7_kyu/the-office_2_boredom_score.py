# Occasionally people in the office moves teams or departments. Depending on what people are doing with their time
...
def boredom(staff):
    ...
    total = sum(scores[staff[name]] for name in staff)
    if total <= 80:
        return 'kill me now'
    if 100 > total > 80:
